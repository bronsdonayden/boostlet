...
class Util {
    static detect_framework() {
        ...
        if (Util.is_defined(window.nv) && window.nv.volumes !== undefined) framework = new (0, $lBIzH.NiiVue)(window.nv);
        else if (Util.is_defined(window.niivue) && window.niivue.volumes !== undefined) framework = new (0, $lBIzH.NiiVue)(window.niivue);
    ...
    static async load_script(url, callback) {
        if (typeof window.Object.global === "undefined") // introducing hack to make it work for openneuro
        // but only do it once
...
class $fbafa14c3ac31938$export$3d6843c2c4a1bd6c extends (0, $bsgU1.Framework) {
    ...
    get_image(from_canvas) {
        ...
        let width = null;
        let height = null;
        if (!(0, $gk9zP.Util).is_defined(from_canvas)) {
            // use the canvas
...
const $edf78858489332f9$var$NUMPY_TS_URL = "https://esm.run/numpy-ts";
let $edf78858489332f9$var$_np = null;
// only load numpy-ts once, cache it in _np
async function $edf78858489332f9$var$_load() {
    if (!$edf78858489332f9$var$_np) $edf78858489332f9$var$_np = await import($edf78858489332f9$var$NUMPY_TS_URL);
    return $edf78858489332f9$var$_np;
}
async function $edf78858489332f9$export$6d8fb4b23c50da2f() {
    const np = await $edf78858489332f9$var$_load();
    return {
...
class $c41144187e031f80$export$a1c8e230980baa0 {
   ...
   */ async stats() {
        return (0, $edf78858489332f9$export$6d8fb4b23c50da2f)();
    }
}
