...
class Util {
    ...
    static detect_framework() {
        ...
        if (Util.looks_like_niivue(window.nv)) framework = new (0, $lBIzH.NiiVue)(window.nv);
        else if (Util.looks_like_niivue(window.niivue)) framework = new (0, $lBIzH.NiiVue)(window.niivue);
        else {
            ...
            if (found) framework = new (0, $lBIzH.NiiVue)(found);
